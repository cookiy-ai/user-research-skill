...
counters. Report generation does not charge here from MCP because manual
generation is not exposed. OAuth signup bonus is folded into cash credit
rather than exposed as a separate field, and the same wallet may be used
