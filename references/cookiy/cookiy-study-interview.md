...
```
node scripts/cookiy.js study interview list --study-id <uuid> [--cursor <s>]
```
...
```
node scripts/cookiy.js study interview playback url --study-id <uuid> [--interview-id <uuid>]
```
...
```
node scripts/cookiy.js study interview playback content --study-id <uuid> [--interview-id <uuid>]
```
